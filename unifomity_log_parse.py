                    ...
                    for iter_num in range(iteration):
                        ...
                        for i in range(xmax):
                            ...
                            if restrict(mahimahi_results[log_name]['tput_list'][i],b,15) and a< 20/wnd :
                                ...
                                tpl[iter_num][a][1]+=1
                                continue
                            if restrict(mahimahi_results[log_name]['tput_list'][i],2*b,35) and a< 40/wnd :
                                tl[a][0]+=mahimahi_results[log_name]['tput_list'][i]
                                tl[a][1]+=1  
                                tpl[iter_num][a][0]+=mahimahi_results[log_name]['tput_list'][i]
                                tpl[iter_num][a][1]+=1
                        ...
                        plt.plot(
                            mahimahi_results[log_name]['time_list'][start:],
                            mahimahi_results[log_name]['tput_list'][start:])
                        pbar.update(1)
